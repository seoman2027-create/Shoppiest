...
export const allProducts = [
    { name: "Wireless headphones", category: "electronics", price: 120.19, img: `${process.env.PUBLIC_URL}/headphones.png`, width: 200, height: 180, source: "/Details?item=headphones"},
    { name: "Casual t-shirt", category: "fashion", price: 35.35, img: `${process.env.PUBLIC_URL}/t-shirt.png`, width: 150, height: 150, source: "/Details?item=t-shirt" },
    { name: "Nike Running shoes", category: "shoes", price: 95.89, img: `${process.env.PUBLIC_URL}/shoes.png`, width: 160, height: 160, source: "/Details?item=shoes" },
